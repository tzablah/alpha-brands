...
const ContactSection = () => {
  ...
  return (
    <section
      className="flex justify-center bg-contact px-4 py-20 lg:h-contactSection relative"
    >
      {send ? <BgContactSend className="absolute hidden lg:block" /> : <BgContact className="absolute xl:ml-8 xl:w-full hidden lg:block" />}
      <div
        className={`${send && "sm:py-56 lg:py-60"} lg:container xl:max-w-contactSection xl:h-full mx-auto text-center`}
      >
        <Title
        ...
        >
          ...
          >
            ...
            <input
              className="z-20 w-11/12 lg:w-5/12 h-input placeholder-input my-3 p-4"
              placeholder="Nombre"
              name="Nombre"
            ...
            />
            <textarea
              className="z-20 w-11/12 lg:w-5/12 h-32 placeholder-input my-3 p-4"
              placeholder="Mensaje..."
              name="Mensaje"
              onChange={handleInputs}
            />
            <button
              type="submit"
              className={`z-20 mt-6 sm:mt-8 bg-blueBright w-64 py-5 rounded-full text-white tracking-widest font-semibold
