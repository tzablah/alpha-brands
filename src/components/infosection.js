  ...
  return (
    <article className="my-3 sm:my-24">
      <div className={`flex flex-col items-center sm:justify-around w-full xl:w-aboutSection ${position === "right" ? "sm:flex-row" : "sm:flex-row-reverse"}`}>
        <div className={`sm:w-1/2 sm:flex sm:flex-wrap sm:flex-row sm:items-center ${position === "right" ? "xl:mr-brandMargin" : "xl:ml-brandMargin"}`}>
        ...
        <div className={`w-1/2 flex justify-center ${position === "right" ? "sm:justify-end xl:ml-brandMargin" : "sm:justify-start xl:mr-brandMargin"}`}>
