...
const InfoSection = ({ image, position, text, title, id }) => {
  return (
    <article className="xl:my-20 sm:my-12 md:my-14 mb-20">
      <div
        className={`flex flex-col items-center sm:justify-around sm:w-aboutSectionSm md:w-aboutSectionM lg:w-aboutSectionMd xl:w-aboutSection ${position === "right" ? "md:flex-row" : "md:flex-row-reverse"
          }`}
      >
        <div
