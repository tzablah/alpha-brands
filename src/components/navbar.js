...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {open && mobileNav()}
      <div className="fixed text-sm uppercase top-0 z-40 bg-white md:h-20 md:px-20 p-2 xl:px-32 flex w-full justify-start md:justify-between lg:justify-around items-center shadow-main">
